...
Keep each summary under 120 words: confirmed quantities, method, access and exclusions only. No introduction, repeated history, pricing commentary, workflow instructions or discussion of blank client fields. Put questions only in gap_questions, not again in the summary. No prices or takeoff lines during clarification. Price only after this review, with gap_questions empty and measurement_status resolved. If pricing reveals a new essential question, return questions and NO work-area takeoffs or line items. Never bury an unanswered question in narrative scope or assumptions.`
