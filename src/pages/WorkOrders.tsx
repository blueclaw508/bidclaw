...
export default function WorkOrders() {
  ...
  return <div className="space-y-5">
    <header><h1 className="text-2xl font-bold text-brand-navy">Work Orders</h1><p className="mt-2 text-brand-text-muted">Open a proposal’s crew planner to print quantities, planned hours and work instructions in English or Spanish. This does not assign or dispatch the job.</p></header>
