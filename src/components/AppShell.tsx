...
const navGroups = [
  ...
  {label:'Review & Billing', items:[{to:'/app/crew-review',label:'Review & Finalize'},{to:'/app/wip',label:'Month-end'},{to:'/app/reports',label:'Job Reports'},{to:'/app/activity',label:'Activity History'}]},
