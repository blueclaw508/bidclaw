        ...
        <div className="mt-6 flex items-center justify-between border-t border-slate-100 pt-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="inline-flex items-center gap-2 rounded-lg bg-[#2563EB] px-6 py-2.5 text-sm font-semibold text-white cursor-pointer transition-all duration-100 hover:brightness-110 active:scale-95 active:brightness-90 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
